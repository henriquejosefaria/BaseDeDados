...
INSERT INTO Funcionario
    ...
    VALUES
		('Josef Stalini',45,'M','Empregado de Limpeza',1,1),
        ('Genghis Khan',34,'M','Personal Traineer',2,2),
        ('Fidel Castro',55,'M','Professor de Natação',3,3),
        ('Luigi Green Mario',45,'M','Empregado de Limpeza',4,4),
        ('Usain Bolt',45,'M','Personal Trainner',5,5),
        ('Joseph Goebbels',25,'M','Nutricionista',6,6);
